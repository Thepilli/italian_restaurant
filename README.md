...
[![GetX](https://img.shields.io/badge/GetX--ffcc30.svg?style=flat-square&logo=firebase)](https://firebase.google.com/)
...
```
git clone https://github.com/Thepilli/italian_restaurant.git
```
...
The Italian Application is released under the MIT License. Refer to the LICENSE file in the repository for more information.

## Demo

![Alt text](assets/screenshots/Screenshot_20230812-052108.png)
![Alt text](assets/screenshots/Screenshot_20230812-051703.png)
